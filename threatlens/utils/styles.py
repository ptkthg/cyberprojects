...
def apply_global_styles() -> None:
    css = dedent(
        ...
        <style>
            ...
            .stApp {background:radial-gradient(1200px 560px at 12% -20%, rgba(37,99,235,.22), rgba(2,6,23,0)) , #020617;color:#f8fafc;}
            ...
            .tl-banner h3 {font-size:2rem;margin:0 0 .12rem 0;position:relative;z-index:2;}
            .tl-banner p {margin:0;color:#94a3b8;font-size:1rem;position:relative;z-index:2;}
            ...
            .tl-card {background:linear-gradient(180deg,#111827,#0b1220);border:1px solid rgba(56,189,248,.2);border-radius:14px;padding:12px;box-shadow:0 8px 26px rgba(0,0,0,.24);margin-bottom:4px;}
            ...
            [data-testid="stSegmentedControl"] [role="radiogroup"] {flex-wrap:nowrap !important;gap:4px;background:#07111f;border:1px solid rgba(56,189,248,.18);border-radius:12px;padding:4px;min-height:50px;}
            [data-testid="stSegmentedControl"] [role="radio"] {border-radius:10px !important;min-height:40px !important;padding:4px 12px !important;white-space:nowrap !important;font-size:.95rem !important;color:#cbd5e1 !important;background:transparent !important;border:1px solid transparent !important;}
            [data-testid="stSegmentedControl"] [role="radio"][aria-checked="true"] {background:linear-gradient(180deg,rgba(37,99,235,.3),rgba(14,165,233,.2)) !important;border-color:rgba(56,189,248,.5) !important;color:#f8fafc !important;box-shadow:inset 0 -2px 0 #38bdf8;}
            ...
            div[data-testid="stButton"] button[id*="card_"] {text-align:left;min-height:118px;background:linear-gradient(100deg,#0b1220,#0a162b);border:1px solid rgba(56,189,248,.22);padding:.65rem .85rem;box-shadow:0 6px 22px rgba(0,0,0,.22);}
            div[data-testid="stButton"] button[id*="card_"]:hover {border-color:#38bdf8;transform:translateY(-1px);}
            div[data-testid="stButton"] button[id*="card_"] p {white-space:pre-line;font-size:1.02rem;}
            ...
            .tl-chart-card {background:linear-gradient(180deg,#111827,#0b1220);border:1px solid rgba(56,189,248,.22);border-radius:14px;padding:10px 12px 6px 12px;min-height:348px;}
            ...
            .tl-mini-card {background:linear-gradient(180deg,#111827,#0b1220);border:1px solid rgba(56,189,248,.22);border-radius:14px;padding:14px;min-height:348px;}
