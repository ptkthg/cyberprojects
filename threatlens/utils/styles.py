...
def apply_global_styles() -> None:
    css = dedent(
        ...
        <style>
            ...
            .tl-banner h3 {font-size:1.95rem;margin:0 0 .12rem 0;position:relative;z-index:2;font-weight:700;}
            ...
            div[data-testid="stButton"] button[id*="card_"] {text-align:left;min-height:112px;background:linear-gradient(100deg,var(--surface),#0a162b);border:1px solid var(--border);padding:.65rem .85rem;box-shadow:0 6px 22px rgba(0,0,0,.22);}
            ...
            @media (max-width:992px) {
                ...
                [data-testid="stSegmentedControl"] [role="radio"] {font-size:.84rem !important;min-height:34px !important;padding:2px 8px !important;}
